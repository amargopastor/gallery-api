...
import { FastifyRequestType } from '../types/types';
...
const get_image = async (request: FastifyRequestType, reply: FastifyReply) => {
...
// (C)RUD: Add new image
const new_image = async (request: FastifyRequestType, reply: FastifyReply) => {
...
// CR(U)D: Update image
const update_image = async (request: FastifyRequestType, reply: FastifyReply) => {
  const _id = request.params._id;
...
const delete_image = async (request: FastifyRequestType, reply: FastifyReply) => {
  const _id = request.params._id;
